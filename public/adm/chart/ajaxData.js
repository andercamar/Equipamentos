...
var ajax_dashboard_module = {
    ...
    refreshData: function() {
        $(document).ajaxStart($.blockUI({ message: '<small>Carregando...</small><br><img src="https://c.tenor.com/I6kN-6X7nhAAAAAi/loading-buffering.gif"/>' })).ajaxStop($.unblockUI);
